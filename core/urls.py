...
urlpatterns = patterns('',
    ...
    url(r'^bookmark/create_bookmark/$', views.bookmark_create, name='bookmark_create'), # create a bookmark in this collection
    url(r'^bookmark/create_bookmarklet/$', views.bookmarklet_create, name='bookmarklet_create'), # create a bookmark in this collection
